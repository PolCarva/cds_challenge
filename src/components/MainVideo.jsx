    ...
    <div className="w-full lg:w-1/2 h-fit flex flex-col gap-5">
      ...
      <div>
        ...
        <Link
          ...
          className="py-3 px-6 w-full lg:w-auto text-xl lg:text-base text-center bg-primary hover:bg-primary-hover text-white font-bold rounded-md float-right shadow-lg hover:shadow-xl transition duration-300 ease-in-out"
